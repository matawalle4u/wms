    ...
    */
    ...
    abstract class Auth extends DataBase {
        ...
        public function reset_password($username, $old, $new){
            ...
            //$get_old = $this->get($this->__auth_table, ['password'], [$this->__auth_column], []);
 ...
 */
 ...
 class Warehouse extends DataBase{
    ...
    public $warehouse_names = array();
    public $warehouse_ids = array();
    ...
    public function add_warehouse(array $values){
    ...
    public function view_warehouse(array $columns, array $conditions, array $values, $limit){
        ...
        $this->warehouse_names = $this->get($this->warehouse_tbl, $columns, $conditions, $values, $limit);
...
class Utils{
    ...
    public function file_upload($fil, $unique_param, $doc, $owner){
        ...
        if(in_array($_FILES[$fil]['type'], $upload_types)) {
...
class Notifications extends DataBase{
    ...
    public function get_notification(){
        //Category defined the notifcation table to be used
        if($_SESSION['role']=='System' || $_SESSION['role']='b2b'){
            //Fetch all notifcations
            $this->notis = $this->get('admin_noti', ['title', 'content', 'date_of_noti', 'message_icon'], ['owner'], [$_SESSION['role']], 'many');
            //return $this->notis;
            return $this->notis;
            
        }else{
            //fetch only the ones for the user id supplied
    ...
    public function get_messages(){
        ...
        if($_SESSION['role']=='System' || $_SESSION['role']='b2b'){
            //Fetch all notifcations
            $this->notis = $this->join_get('admin_message','users','sender', 'user_id',  ['subject','name', 'body', 'date_sent','sender', 'message_icon'], ['message_owner'], [$_SESSION['role']], 'many');
            //return $this->notis;
            return $this->notis;
