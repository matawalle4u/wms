<?php
  ...
  if(!isset($_SESSION['email']) || isset($_GET['logout'])){
    ...
    $products = $us->join_get('stocks', 'products', 'product', 'product_id', ['description', 'img_src'],[],[], 'many');
    ...
    <div class="row">
      ...
      <?php
        foreach($products as $index=>$item){
          ...
          <div class=\"card\">
            <div class=\"card-content\">
            <img class=\"card-img-top img-fluid\" src=\"../admin/$image\" alt=\"$name\" />
                  <div class=\"card-body\">
                  <h4 class=\"card-title\" id=\"productPrice\">$name [$19.8]</h4>
                  <p>
                      <input class=\"col-sm-12 col-md-7 float-right\" placeholder=\"Quantity\" type=\"text\" min=\"1\" id=\"productQty\" >
                      <input class=\"col-sm-12 col-md-7 float-right\" placeholder=\"Total\" type=\"text\" min=\"1\" id=\"productTotal\" readonly>
                  </p>
