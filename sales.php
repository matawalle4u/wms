<?php
  ...
  $us->logout('index.php', 'Sales Agent');
          ...
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">         
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><i></i></span><span class="user-name"><?php echo $_SESSION['name'];?></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="update_profile.php"><i class="ft-user"></i> Edit Profile</a><a class="dropdown-item" href="email-application.html"><i class="ft-mail"></i> My Inbox</a><a class="dropdown-item" href="messenger.php"><i class="ft-message-square"></i> Chats</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-folder"></i><span class="menu-title" data-i18n="nav.category.general">Sales</span></a>
          ...
          <div class="content-header-left col-md-6 col-12 mb-2">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a data-toggle="modal" data-target="#addwharehouse" href="#">Makes sales</a>
                  </li>
                  <li class="breadcrumb-item"><a data-toggle="modal" data-target="#updatewarehouse" href="#">Edit sales</a>
                  </li>
                  <li class="breadcrumb-item"> <a data-toggle="modal" data-target="#addrack" href="#">View orders</a>
                  </li>

                  <li class="breadcrumb-item"> <a data-toggle="modal" data-target="#addrack" href="#">View reports</a>
                  </li>
...
<!--/ Javascript sourced data -->
    ...
    <div class="modal fade text-left" id="addwharehouse" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <h4 class="modal-title" id="myModalLabel1">Makes Sales</h4>
