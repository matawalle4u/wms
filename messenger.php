...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-compact-menu content-left-sidebar chat-application  menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="content-left-sidebar">
        ...
        <div class="users-list-padding media-list">
            <a href="#" class="media border-0">
                <div class="media-left pr-1">
                    <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="src/Daniel.jpeg" alt="Generic placeholder image">
                    <i></i>
                    </span>
                </div>
            ...
            <a href="#" class="media border-0">
                <div class="media-left pr-1">
                    <span class="avatar avatar-md avatar-busy"><img class="media-object rounded-circle" src="src/Daniel.jpeg" alt="Generic placeholder image">
                    <i></i>
                    </span>
                </div>
                <div class="media-body w-100">
            ...
            <a href="#" class="media border-0">
                <div class="media-left pr-1">
                    <span class="avatar avatar-md avatar-away"><img class="media-object rounded-circle" src="src/Daniel.jpeg" alt="Generic placeholder image">
                    <i></i>
                    </span>
                </div>
                <div class="media-body w-100">
          ...
          <div class="chat">
            <div class="chat-avatar">
              <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                  <img src="src/Daniel.jpeg" alt="avatar" />
              </a>
            </div>
            <div class="chat-body">
